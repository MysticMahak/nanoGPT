...
start = "But your manual KV path does not exactly match Flash Attention semantics. This can cause tiny numerical differences that compound during generation. Not the main issue — but worth knowing." # or "<|endoftext|>" or etc. Can also specify a file, use as: "FILE:prompt.txt"
